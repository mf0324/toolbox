...
#ifndef PROTOBUF_src_2fproto_2faddressbook_2eproto__INCLUDED
#define PROTOBUF_src_2fproto_2faddressbook_2eproto__INCLUDED
...
class Person_PhoneNumber : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* number_;
  int type_;
  friend void  protobuf_AddDesc_src_2fproto_2faddressbook_2eproto();
  friend void protobuf_AssignDesc_src_2fproto_2faddressbook_2eproto();
  friend void protobuf_ShutdownFile_src_2fproto_2faddressbook_2eproto();
...
#endif  // PROTOBUF_src_2fproto_2faddressbook_2eproto__INCLUDED
